...
class TestSetVirkningEnddate(unittest.TestCase):

    def test_should_have_virkning_to_2017_12_31(self):
        pass
        # self.assertEqual('2017-12-31T00:00:00+01:00', expected_output[])